...
### Python app
The default build and publish process is configured for a python application (`.github\workflows\build_python.yaml`).
During this process, a Docker image is built and a Helm chart is created.
**After execution**  
